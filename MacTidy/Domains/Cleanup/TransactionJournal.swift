...
public actor TransactionJournal {
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.mactidy", category: "TransactionJournal")
    ...
    public init(journalURL: URL? = nil) {
        if let url = journalURL {
            ...
            let journalDir = appSupport.appendingPathComponent("MacTidy", isDirectory: true)
