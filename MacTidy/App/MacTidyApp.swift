...
private let crashLogger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "input.MacTidy", category: "Crash")
...
struct MacTidyApp: App {
    ...
    init() {
        ...
        Task {
            ...
            MacTidyShortcuts.updateAppShortcutParameters()
        }
    }
        ...
        .commands {
            CommandGroup(replacing: .appInfo) {
                ...
                Button("menu_donate".localized) {
                    if let url = URL(string: "https://github.com/princepal9120/MacTidy/blob/main/DONATE.md") {
        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                HStack(alignment: .firstTextBaseline, spacing: 4) {
                    ...
                    Link("https://github.com/princepal9120/MacTidy/releases", destination: URL(string: "https://github.com/princepal9120/MacTidy/releases")!)
                        .font(.system(size: 11))
                }
            }
        }
