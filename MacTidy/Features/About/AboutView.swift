...
struct AboutView: View {
    ...
    private var linksCard: some View {
        VStack(spacing: 0) {
            Link(destination: URL(string: "https://github.com/princepal9120/MacTidy/blob/main/DONATE.md")!) {
            ...
            Link(destination: URL(string: "https://github.com/princepal9120/MacTidy")!) {
            ...
            Divider().padding(.leading, 38)
            Link(destination: URL(string: "https://github.com/princepal9120/MacTidy/issues")!) {
