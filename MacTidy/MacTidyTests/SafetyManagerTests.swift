...
final class SafetyManagerTests: XCTestCase {
    ...
    func testSymlinkEscape() throws {
        ...
        let tempDir = URL(fileURLWithPath: home).appendingPathComponent("Library/Application Support/MacTidyTests_Safety")
    ...
    func testLeafSymlinkIsAllowed() throws {
        let tempDir = URL(fileURLWithPath: home).appendingPathComponent("Library/Application Support/MacTidyTests_LeafSymlink")
        if FileManager.default.fileExists(atPath: tempDir.path) {
            try? FileManager.default.removeItem(at: tempDir)
        }
        try FileManager.default.createDirectory(at: tempDir, withIntermediateDirectories: true)
    ...
    func testNoHardcodedDeveloperPaths() {
        ...
        let developerPath = "\(home)/Documents/my/mactidy/Sources"
    ...
    func testCustomAllowedExceptions() {
        ...
        let customPath = "\(home)/Documents/my/mactidy/Sources"
