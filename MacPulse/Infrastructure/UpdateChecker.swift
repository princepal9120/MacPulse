...
private extension Logger {
    static let updater = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.macpulse", category: "UpdateChecker")
}
...
public actor UpdateChecker {
    public static let releasesURL = URL(string: "https://github.com/princepal9120/MacPulse/releases")!
    private static let apiURL = URL(string: "https://api.github.com/repos/princepal9120/MacPulse/releases/latest")!
