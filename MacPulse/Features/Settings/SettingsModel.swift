...
struct SettingsSearchRegistry {
    static let allItems: [SettingsItem] = [
        ...
        SettingsItem(id: "replayOnboarding", category: .general, titleKey: "settings_replay_onboarding", subtitleKey: "settings_replay_onboarding_sub", keywords: ["onboarding", "welcome", "tour", "replay", "this mac", "онбординг", "тур"], iconName: "sparkles"),
