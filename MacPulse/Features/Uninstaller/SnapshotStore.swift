...
private extension Logger {
    static let snapshot = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.macpulse", category: "SnapshotStore")
}
...
public actor SnapshotStore {
    ...
    public init(
        ...
        self.storageURL = appSupport.appendingPathComponent("MacPulse/Snapshots", isDirectory: true)
