...
private extension Logger {
    static let lsCache = Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.macpulse", category: "LSRegisterCache")
}
...
public actor LSRegisterCache {
    ...
    public init() {
        ...
        self.storageURL = cachesDir.appendingPathComponent("com.macpulse/lsregister.json")
        Task { await load() }
    }
